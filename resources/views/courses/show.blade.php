        ...
        <div class="p-8">
            ...
            <div class="border-t pt-6 flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="{{ route('enrollments.create', $course->slug) }}" class="inline-flex items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-primary-600 hover:bg-primary-700">
