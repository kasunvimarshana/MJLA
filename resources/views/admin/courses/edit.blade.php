        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="level" id="level" required
                    ...
                    <option value="JLPT N5" {{ old('level', $course->level) == 'JLPT N5' ? 'selected' : '' }}>JLPT N5</option>
                    <option value="JLPT N4" {{ old('level', $course->level) == 'JLPT N4' ? 'selected' : '' }}>JLPT N4</option>
                    <option value="JLPT N3" {{ old('level', $course->level) == 'JLPT N3' ? 'selected' : '' }}>JLPT N3</option>
                    <option value="JLPT N2" {{ old('level', $course->level) == 'JLPT N2' ? 'selected' : '' }}>JLPT N2</option>
                    <option value="JLPT N1" {{ old('level', $course->level) == 'JLPT N1' ? 'selected' : '' }}>JLPT N1</option>
                </select>
                @error('level')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="number" name="duration_weeks" id="duration_weeks" value="{{ old('duration_weeks', $course->duration_weeks) }}" min="1" required
                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" id="description" rows="4" required
                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $course->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2 space-y-4">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured', $course->is_featured) ? 'checked' : '' }}
                        class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900">
