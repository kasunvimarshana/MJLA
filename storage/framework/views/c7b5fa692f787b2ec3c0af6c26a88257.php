<?php $__env->startSection('title', __('messages.contact.title') . ' - ' . config('app.name')); ?>
<?php $__env->startSection('description', __('messages.contact.subtitle')); ?>
...
<div class="container-custom py-12">
    ...
    <div class="text-center mb-12" data-aos="fade-up">
        ...
        <p class="section-subtitle max-w-3xl mx-auto">
            <?php echo e(__('messages.contact.subtitle')); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8" data-aos="fade-right">
            <h2 class="text-2xl font-bold text-gray-900 mb-6"><?php echo e(__('messages.contact.send')); ?></h2>
            ...
            <?php if($errors->any()): ?>
                <div class="bg-red-50 border-l-4 border-red-400 p-4 mb-6 rounded-lg" data-flash-message>
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-red-800"><?php echo e(__('messages.forms.error')); ?></h3>
            ...
            <form action="<?php echo e(route('contact.store')); ?>" method="POST" class="space-y-6" data-validate>
                <?php echo csrf_field(); ?>

                <!-- Name -->
                <div>
                    <label for="name" class="form-label">
                        <?php echo e(__('messages.contact.name')); ?> <span class="text-red-500">*</span>
                    </label>
                    <input type="text" 
                           name="name" 
                           id="name" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <label for="email" class="form-label">
                        <?php echo e(__('messages.contact.email')); ?> <span class="text-red-500">*</span>
                    </label>
                    <input type="email" 
                           name="email" 
                           id="email" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <label for="subject" class="form-label">
                        <?php echo e(__('messages.contact.subject')); ?> <span class="text-red-500">*</span>
                    </label>
                    <input type="text" 
                           name="subject" 
                           id="subject" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <label for="message" class="form-label">
                        <?php echo e(__('messages.contact.message')); ?> <span class="text-red-500">*</span>
                    </label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <button type="submit" class="btn btn-primary w-full" data-loading-button>
                        ...
                        <?php echo e(__('messages.contact.send')); ?>

                    </button>
                </div>

                <p class="text-sm text-gray-600 text-center">
                    <span class="text-red-500">*</span> <?php echo e(__('messages.forms.required')); ?>
        ...
        <div class="space-y-6" data-aos="fade-left">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-6"><?php echo e(__('messages.contact.info')); ?></h2>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-gray-900"><?php echo e(__('messages.contact.address')); ?></h3>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-gray-900"><?php echo e(__('messages.contact.phone')); ?></h3>
                            <p class="mt-1 text-gray-600">
            ...
            <div class="bg-gradient-primary rounded-xl shadow-lg p-8 text-white">
                <h2 class="text-2xl font-bold mb-4"><?php echo e(__('messages.contact.follow_us')); ?></h2>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/MJLA/MJLA/resources/views/contact/index.blade.php ENDPATH**/ ?>